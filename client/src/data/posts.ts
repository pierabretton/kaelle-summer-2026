...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title: "Finding New Ways to Give Your Kids Vegetables: The Green Pasta That Changed Everything",
    subtitle: "How a blended broccoli, spinach and halloumi sauce became Kaelle's favourite meal — and our full camp week menu.",
    publishDate: "2026-07-06",
    readTime: "4 min read",
    category: "Food & Nutrition",
    tags: ["hidden veg recipes", "toddler vegetables", "picky eater toddler", "broccoli pasta for toddlers", "toddler camp lunches", "halloumi pasta sauce"],
    metaDescription: "A hidden-veg green pasta sauce made with broccoli, spinach and halloumi that picky toddlers actually love. Plus our full 5-day summer camp lunch menu for a 3-year-old.",
    bluf: "Getting vegetables into a picky toddler is one of the great daily challenges of parenting. Our solution: a green pasta sauce made by blending broccoli, spinach and halloumi together. It looks like pesto, tastes creamy and salty, and hides an entire head of broccoli. Kaelle eats it without question and asks for seconds. This post has the full recipe and our complete 5-day camp lunch menu.",
    heroEmoji: "🍱",
    camps: [],
    affiliateLinks: [],
  },
